...
This is a mini banking management system, written in DotNet 7, a project idea by [sannlynnhtun-coding](https://github.com/sannlynnhtun-coding).

Full documentation can be found [here](https://github.com/sannlynnhtun-coding/Banking-Management-System). 

Example project from [sannlynnhtun-coding](https://github.com/sannlynnhtun-coding) can be found [here](https://github.com/sannlynnhtun-coding/DotNet8.BankingManagementSystem).

<details>
  <summary>Full Documentation By @sannlynnhtun-coding (In Burmese) </summary>
